...
description: >-
  ...
  RibbonDiff.xml, Other/Customizations.xml, SiteMap XML, or FormXml — especially adding a
  ribbon / command-bar button ("add a ribbon button", "command bar button", "RibbonDiffXml",
  "custom action", "CommandDefinition", "JavaScriptFunction"), editing app navigation
  (SiteMap), or validating any Dataverse customization XML fragment. Provides a standalone
  PowerShell validator (Validate-DataverseXml.ps1) and live lemminx LSP diagnostics.
---
